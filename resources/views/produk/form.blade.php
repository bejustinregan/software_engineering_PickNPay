        ...
        <form action="" method="post" class="form-horizontal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="harga_beli" class="col-lg-2 col-lg-offset-1 control-label">Buy Price</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="harga_jual" class="col-lg-2 col-lg-offset-1 control-label">Sell Price</label>
                        <div class="col-lg-6">
